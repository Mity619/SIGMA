...
const cards: AdminCard[] = [
  {
    id: 'academic',
    title: 'Empieza Tu Proceso Matricula',
    description:
      'Ingresa para empezar tu proceso de matricula correspondiente a tu pensum.',
  ...
  {
    id: 'news',
    title: 'Administración de Tu Historial',
    description:
      'Añade, edita y elimina tus materias a tu historial de tu pensum.',
    ...
    <div className="dashboard-admin">
      ...
      <main className="dashboard-admin__main">
        ...
        <header className="dashboard-admin__header">
          <div className="dashboard-admin__header-badge">Panel Académico</div>
          <h1 className="dashboard-admin__title">Panel de Estudiante</h1>
          <p className="dashboard-admin__subtitle">
            Desde aqui puedes hacer provecho y uso de las funciones de SIGMA: Matriculate y Maneja tu historial Academico
          </p>
        </header>
